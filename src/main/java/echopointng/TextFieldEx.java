...
public class TextFieldEx extends TextField implements Attributeable, Borderable, MouseCursorable, Sizeable, Insetable, ToolTipable, AccessKeyable {
	...
	/**
	 * @return true if this <code>TextFieldEx</code> is rendered as a hidden input field. This is different
	 * 			to calling setVisible(false), which will stop the field from being rendered entirely.
	 */
	...
	/**
	 * Allows you to set the <code>TextFieldEx</code> to be rendered as a hidden input field. 
	 * This is different to calling setVisible(false), which will stop the field from being rendered entirely.
	 */
