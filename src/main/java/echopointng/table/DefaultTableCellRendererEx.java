...
public class DefaultTableCellRendererEx extends DefaultTableCellRenderer implements TableCellRendererEx {
	 ...
	 *
	 * @see nextapp.echo2.app.table.DefaultTableCellRenderer#getTableCellRendererComponent(nextapp.echo2.app.Table, java.lang.Object, int, int)
	 */
	public Component getTableCellRendererComponent(Table table, Object value, int column, int row) {
		return null;
	}
	/**
	 * @see echopointng.table.TableCellRendererEx#getTableCellRendererContent(Table, Object, int, int)
	 */
	 ...
	 */
	public boolean isActionCausingCells(Table table, int column, int row) {
		return true;
	}
	
	/**
	 * @see echopointng.table.TableCellRendererEx#isSelectionCausingCell(nextapp.echo2.app.Table, int, int)
	 */
